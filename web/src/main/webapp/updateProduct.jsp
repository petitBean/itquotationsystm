...
<head>
    ...
    <script>
        function fun(){
            var productU = '<%=session.getAttribute("productU") %>';
            $("input[name='trademark'][value='" + productU.tmCode + "']").prop("checked", "checked");

            $("input[name='pType'][value='" + productU.pType + "']").prop("checked", "checked");

            $("input[name='pPosition'][value='" + productU.pPosition + "']").prop("checked", "checked");

            $("input[name='pOS'][value='" + productU.pOS + "']").prop("checked", "checked");

            $("input[name='pChipset'][value='" + productU.pChipset + "']").prop("checked", "checked");

            $("input[name='pTouch'][value='" + productU.pTouch + "']").prop("checked", "checked");

            $("input[name='pScreenSize'][value='" + productU.pScreenSize + "']").prop("checked", "checked");

            $("input[name='pScreenResolution1'][value='" + productU.pScreenResolution + "']").prop("checked", "checked");

            $("input[name='pTechnology'][value='" + productU.pTechnology + "']").prop("checked", "checked");

            $("input[name='pCamera'][value='" + productU.pCamera + "']").prop("checked", "checked");

            $("input[name='pAudio'][value='" + productU.pAudio + "']").prop("checked", "checked");

            $("input[name='pSpeaker'][value='" + productU.pSpeaker + "']").prop("checked", "checked");

            $("input[name='pMike'][value='" + productU.pMike + "']").prop("checked", "checked");

            $("input[name='pWlan'][value='" + productU.pWlan + "']").prop("checked", "checked");

            $("input[name='pLan'][value='" + productU.pLan + "']").prop("checked", "checked");

            $("input[name='pBluetooth'][value='" + productU.pBluetooth + "']").prop("checked", "checked");

            $("input[name='pDataInterface'][value='" + productU.pDataInterface + "']").prop("checked", "checked");

            $("input[name='pAudioInterface'][value='" + productU.pAudioInterface + "']").prop("checked", "checked");

            $("input[name='pVideoInterface'][value='" + productU.pVideoInterface + "']").prop("checked", "checked");

            $("input[name='pOtherInterface'][value='" + productU.pOtherInterface + "']").prop("checked", "checked");

            $("input[name='pFingerEquipment'][value='" + productU.pFingerEquipment + "']").prop("checked", "checked");

            $("input[name='pKeyboard'][value='" + productU.pKeyboard + "']").prop("checked", "checked");

            $("input[name='ppFingerprintldentific'][value='" + productU.pFingerprintldentific + "']").prop("checked", "checked");

            $("input[name='pBatteryType'][value='" + productU.pBatteryType + "']").prop("checked", "checked");

            $("input[name='pDuration'][value='" + productU.pDuration + "']").prop("checked", "checked");

            $("input[name='pPowerAdapter'][value='" + productU.pPowerAdapter + "']").prop("checked", "checked");

            $("input[name='pWeight'][value='" + productU.pWeight + "']").prop("checked", "checked");

            $("input[name='pLengh'][value='" + productU.pLengh + "']").prop("checked", "checked");

            $("input[name='pWidth'][value='" + productU.pWidth + "']").prop("checked", "checked");

            $("input[name='pThickness'][value='" + productU.pThickness + "']").prop("checked", "checked");

            $("input[name='pShellMaterial'][value='" + productU.pShellMaterial + "']").prop("checked", "checked");

            $("input[name='pSheelDescription'][value='" + productU.pSheelDescription + "']").prop("checked", "checked");

            $("input[name='pSafety'][value='" + productU.pSafety + "']").prop("checked", "checked");

            $("input[name='pDissipation'][value='" + productU.pDissipation+ "']").prop("checked", "checked");

            $("input[name='pSoftware'][value='" + productU.pSoftware + "']").prop("checked", "checked");

            $("input[name='pPackageList'][value='" + productU.pPackageList + "']").prop("checked", "checked");

            $("input[name='pGuarantee'][value='" + productU.pGuarantee + "']").prop("checked", "checked");

            $("input[name='pWarranty'][value='" + productU.pWarranty + "']").prop("checked", "checked");

            $("input[name='pWarrantyRemark'][value='" + productU.pWarrantyRemark + "']").prop("checked", "checked");

            $("input[name='pTel'][value='" + productU.pTel + "']").prop("checked", "checked");

            $("input[name='pTelRemark'][value='" + productU.pTelRemark + "']").prop("checked", "checked");

            $("input[name='pDetail'][value='" + productU.pDetail + "']").prop("checked", "checked");

            $("input[name='CPU'][value='" + productU.pCPUType + "']").prop("checked", "checked");

            $("input[name='pCPUHZ'][value='" + productU.pCPUHZ + "']").prop("checked", "checked");

            $("input[name='pCPUMHZ'][value='" + productU.pCPUMHZ + "']").prop("checked", "checked");

            $("input[name='pCPUAmount'][value='" + productU.pCPUAmount + "']").prop("checked", "checked");

            $("input[name='pTread'][value='" + productU.pTread + "']").prop("checked", "checked");

            $("input[name='pCache'][value='" + productU.pCache + "']").prop("checked", "checked");

            $("input[name='pBus'][value='" + productU.pBus + "']").prop("checked", "checked");

            $("input[name='Structure'][value='" + productU.pStructure + "']").prop("checked", "checked");

            $("input[name='pCraft'][value='" + productU.pCraft + "']").prop("checked", "checked");


            $("input[name='pConsumption'][value='" + productU.pConsumption + "']").prop("checked", "checked");

            $("input[name='pRAM'][value='" + productU.pRAM + "']").prop("checked", "checked");

            $("input[name='pRAMC'][value='" + productU.pRAMC + "']").prop("checked", "checked");

            $("input[name='pRAMType'][value='" + productU.pRAMType + "']").prop("checked", "checked");

            $("input[name='pSSD'][value='" + productU.pSSD + "']").prop("checked", "checked");

            $("input[name='pDisk'][value='" + productU.pDisk + "']").prop("checked", "checked");

            $("input[name='pROMDescription'][value='" + productU.pROMDescription + "']").prop("checked", "checked");

            $("input[name='pCD'][value='" + productU.pCD + "']").prop("checked", "checked");

            $("input[name='pGPUType'][value='" + productU.pGPUType + "']").prop("checked", "checked");

            $("input[name='pGPUName'][value='" + productU.pGPUName + "']").prop("checked", "checked");

            $("input[name='pGPURAM'][value='" + productU.pGPURAM + "']").prop("checked", "checked");

            $("input[name='pGDDR'][value='" + productU.pGDDR + "']").prop("checked", "checked");

            $("input[name='pGPUBit'][value='" + productU.pGPUBit + "']").prop("checked", "checked");

            $("input[name='pPicture'][value='" + productU.pPicture + "']").prop("checked", "checked");
    ...
    <%--
        <script>
            $(function() {
                var sex = '<%=session.getAttribute("tmName") %>';
                alert(sex);
                $("input[name='trademark'][value='" + sex + "']").prop("checked", "checked");
            });
        </script>--%>
...
<div class="wrapper">
    ...
    <form action="${pageContext.request.contextPath}/updateProduct.do" method="post">

        <div class="s_condition clearfix" id="s_filter">
            <div class="title_ser"><strong>修改产品</strong><span></span>
            </div>
            ...
            <dl id="manuSer">
                ...
                <dt>编码</dt>
                <dd>
                    <input type="text" value="${productU.pCode}" readonly>
                </dd>
                ...
                <dd>
                    ...
                    <label for="manu_24" title="清华同方"><input type="radio" id="manu_24" name="trademark" value="清华同方">清华同方</label>
                    <label for="manu_36391" title="炫龙"><input type="radio" id="manu_36391" name="trademark" value="炫龙">炫龙</label>
                    <label for="manu_143" title="LG"><input type="radio" id="manu_143" name="trademark" value="LG">LG</label>
                    <label for="manu_55731" title="红米"><input type="radio" id="manu_55731" name="trademark" value="红米">红米</label>
                    <label for="manu_54255" title="a豆"><input type="radio" id="manu_54255" name="trademark" value="a豆">a豆</label>
                    <label for="manu_53851" title="吾空"><input type="radio" id="manu_53851" name="trademark" value="吾空">吾空</label>
                    <label for="manu_221" title="海尔"><input type="radio" id="manu_221" name="trademark" value="海尔">海尔</label>
                    <label for="manu_36607" title="火影"><input type="radio" id="manu_36607" name="trademark" value="火影">火影</label>
                    <label for="manu_37353" title="麦本本"><input type="radio" id="manu_37353" name="trademark" value="麦本本">麦本本</label>
                    <label for="manu_50829" title="VAIO"><input type="radio" id="manu_50829" name="trademark" value="VAIO">VAIO</label>
                    <label for="manu_34305" title="Terrans Force"><input type="radio" id="manu_34305" name="trademark" value="Terrans Force">Terrans Force</label>
                    <label for="manu_234" title="技嘉"><input type="radio" id="manu_234" name="trademark" value="技嘉">技嘉</label>
                    <label for="manu_209" title="东芝"><input type="radio" id="manu_209" name="trademark" value="东芝">东芝</label>
                    <label for="manu_54562" title="壹号本"><input type="radio" id="manu_54562" name="trademark" value="壹号本">壹号本</label>
                    <label for="manu_283" title="富士通"><input type="radio" id="manu_283" name="trademark" value="富士通">富士通</label>
                    <label for="manu_1922" title="谷歌"><input type="radio" id="manu_1922" name="trademark" value="谷歌">谷歌</label>
                    <label for="manu_34329" title="锡恩帝"><input type="radio" name="trademark" id="manu_34329" value="锡恩帝">锡恩帝</label>
                    <label for="manu_265" title="昂达"><input type="radio" id="manu_265" name="trademark" value="昂达">昂达</label>
                    <label for="manu_84" title="松下"><input type="radio" id="manu_84" name="trademark" value="松下">松下</label>
                    <label for="manu_47841" title="宝扬"><input type="radio" id="manu_47841" name="trademark" value="宝扬">宝扬</label>
                    <label for="manu_35232" title="海鲅"><input type="radio" id="manu_35232" name="trademark" value="海鲅">海鲅</label>
                    <label for="manu_2251" title="酷比魔方"><input type="radio" id="manu_2251" name="trademark" value="酷比魔方">酷比魔方</label>
                    <label for="manu_52061" title="博本"><input type="radio" id="manu_52061" name="trademark" value="博本">博本</label>
                    <label for="manu_51642" title="ENZ"><input type="radio" id="manu_51642" name="trademark" value="ENZ">ENZ</label>
                    <label for="manu_50972" title="爱尔轩"><input type="radio" id="manu_50972" name="trademark" value="爱尔轩">爱尔轩</label>
                    <label for="manu_34055" title="索立信"><input type="radio" id="manu_34055" name="trademark" value="索立信">索立信</label>
                    <label for="manu_47070" title="刀客"><input type="radio" id="manu_47070" name="trademark" value="刀客">刀客</label>
                    <label for="manu_34130" title="镭波"><input type="radio" id="manu_34130" name="trademark" value="镭波">镭波</label>
                    <label for="manu_49394" title="紫麦"><input type="radio" id="manu_49394" name="trademark" value="紫麦">紫麦</label>
                    <label for="manu_54916" title="AVITA"><input type="radio" id="manu_54916" name="trademark" value="AVITA">AVITA</label>
                    <label for="manu_51268" title="金属大师"><input type="radio" id="manu_51268" name="trademark" value="金属大师">金属大师</label>
                    <label for="manu_33832" title="SOSOON"><input type="radio" id="manu_33832" name="trademark" value="SOSOON">SOSOON</label>
                    <label for="manu_26" title="长城"><input type="radio" id="manu_26" name="trademark" value="长城">长城</label>
                    <label for="manu_23" title="七喜"><input type="radio" id="manu_23" name="trademark" value="七喜">七喜</label>
                    <label for="manu_171" title="TCL"><input type="radio" id="manu_171" name="trademark" value="TCL">TCL</label>
                    <label for="manu_212" title="方正"><input type="radio" id="manu_212" name="trademark" value="方正">方正</label>
                    <label for="manu_249" title="紫光"><input type="radio" id="manu_249" name="trademark" value="紫光">紫光</label>
                    <label for="manu_167" title="索尼"><input type="radio" id="manu_167" name="trademark" value="索尼">索尼</label>
                    <label for="manu_151" title="NEC"><input type="radio" id="manu_151" name="trademark" value="NEC">NEC</label>
                    <label for="manu_51186" title="翼昇"><input type="radio" id="manu_51186" name="trademark" value="翼昇">翼昇</label>
                    <label for="manu_125" title="Intel"><input type="radio" id="manu_125" name="trademark" value="Intel">Intel</label>
                    <label for="manu_300" title="夏普"><input type="radio" id="manu_300" name="trademark" value="夏普">夏普</label>
                    <label for="manu_314" title="优派"><input type="radio" id="manu_314" name="trademark" value="优派">优派</label>
                    <label for="manu_34021" title="科之光"><input type="radio" id="manu_34021" name="trademark" value="科之光">科之光</label>
                    <label for="manu_34018" title="明唐"><input type="radio" id="manu_34018" name="trademark" value="明唐">明唐</label>
                    <label for="manu_19776" title="瀚斯宝丽"><input type="radio" id="manu_19776" name="trademark" value="瀚斯宝丽">瀚斯宝丽</label>
                    <label for="manu_33677" title="典籍"><input type="radio" id="manu_33677" name="trademark" value="典籍">典籍</label>
                    <label for="manu_32479" title="索泰"><input type="radio" id="manu_32479" name="trademark" value="索泰">索泰</label>
                    <label for="manu_33033" title="现代IT世家"><input type="radio" id="manu_33033" name="trademark" value="现代IT世家">现代IT世家</label>
                    <label for="manu_34201" title="富登"><input type="radio" id="manu_34201" name="trademark" value="富登">富登</label>
                    <label for="manu_34264" title="万顺达"><input type="radio" id="manu_34264" name="trademark" value="万顺达">万顺达</label>
                    <label for="manu_36595" title="联想扬天"><input type="radio" id="manu_36595" name="trademark" value="联想扬天">联想扬天</label>
                    <label for="manu_407" title="明基"><input type="radio" id="manu_407" name="trademark" value="明基">明基</label>
                    <label for="manu_813" title="Gateway"><input type="radio" id="manu_813" name="trademark" value="Gateway">Gateway</label>
                    <label for="manu_833" title="多彩"><input type="radio" id="manu_833" name="trademark" value="多彩">多彩</label>
                    <label for="manu_34946" title="Wbin"><input type="radio" id="manu_34946" name="trademark" value="Wbin">Wbin</label>
                    <label for="manu_34842" title="DCMOFA"><input type="radio" id="manu_34842" name="trademark" value="DCMOFA">DCMOFA</label>
                    <label for="manu_34681" title="神酷"><input type="radio" id="manu_34681" name="trademark" value="神酷">神酷</label>
                    <label for="manu_974" title="新蓝"><input type="radio" id="manu_974" name="trademark" value="新蓝">新蓝</label>
                    <label for="manu_33046" title="eMachines"><input type="radio" id="manu_33046" name="trademark" value="eMachines">eMachines</label>
                    <label for="manu_970" title="台电"><input type="radio" id="manu_970" name="trademark" value="台电">台电</label>
                    <label for="manu_33057" title="HD Computer"><input type="radio" id="manu_33057" name="trademark" value="HD Computer">HD Computer</label>
                    <label for="manu_33168" title="COYOB"><input type="radio" id="manu_33168" name="trademark" value="COYOB">COYOB</label>
                    <label for="manu_33141" title="磐正Q-Mi"><input type="radio" id="manu_33141" name="trademark" value="磐正Q-Mi">磐正Q-Mi</label>
                    <label for="manu_1071" title="万利达"><input type="radio" id="manu_1071" name="trademark" value="万利达">万利达</label>
                    <label for="manu_33967" title="索华"><input type="radio" name="trademark" id="manu_33967" value="索华">索华</label>
                    <label for="manu_413" title="七彩虹"><input type="radio" id="manu_413" name="trademark" value="七彩虹">七彩虹</label>
                    <label for="manu_33922" title="天玑"><input type="radio" id="manu_33922" name="trademark" value="天玑">天玑</label>
                    <label for="manu_34002" title="ESER宇朔"><input type="radio" id="manu_34002" name="trademark" value="ESER宇朔">ESER宇朔</label>
                    <label for="manu_33290" title="睿逸"><input type="radio" id="manu_33290" name="trademark" value="睿逸">睿逸</label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>产品名称</dt>
                <dd>
                    <input type="text" name="pName" id="pName" value="${productU.pName}">
                </dd>
            </dl>
            ...
            <dl>
                <dt>上市时间</dt>
                <dd><input type="date" id="datepicker1" value="${productU.publishTime}">
                </dd>
            </dl>
            ...
            <dl>
                <dt>主板芯片组</dt>
                <dd>
                    <input type="text" name="chipset" value="${productU.pChipset}"></dd>
            </dl>
            <%--基本参数--%>
            ...
            <dl>
                ...
                <dd>
                    <label><input type="number" name="pScreenSize" value="${productU.pScreenSize}">英寸</label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>屏幕分辨率</dt>
                <dd>
                    <label><input type="number" name="pScreenResolution1" value="${productU.pScreenResolution}">*<input type="number"
                                                                                                                        name="pScreenResolution2" value="${productU.pScreenResolution}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>音频系统</dt>
                <dd>
                    <label><input type="text" name="pAudio" value="${productU.pAudio}"></label>
                </dd>
            </dl>

            <dl>
                <dt>扬声器</dt>
                <dd><label><input type="text" name="pSpeaker" value="${productU.pSpeaker}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>麦克风</dt>
                <dd>
                    <label><input type="text" name="pMike" value="${productU.pMike}"></label>
                </dd>
            </dl>
            <%--多媒体设备--%>
            ...
            <dl>
                <dt>无线网卡</dt>
                <dd>
                    <label><input type="text" name="pWlan" value="${productU.pWlan}"></label>
            ...
            <dl>
                <dt>有线网卡</dt>
                <dd>
                    <label><input type="text" name="pLan" value="${productU.pLan}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>数据接口</dt>
                <dd>
                    <label><input type="text" name="pDataInterface" value="${productU.pDataInterface}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>音频接口</dt>
                <dd>
                    <label><input type="text" name="pAudioInterface" value="${productU.pAudioInterface}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>视频接口</dt>
                <dd>
                    <label><input type="text" name="pVideoInterface" value="${productU.pVideoInterface}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>其他接口</dt>
                <dd>
                    <label><input type="text" name="pOtherInterface" value="${productU.pOtherInterface}"></label>
                </dd>
            </dl>
            <%--I/O接口--%>
            ...
            <dl>
                <dt>指取设备</dt>
                <dd>
                    <label><input type="text" name="pFingeringEquipment" value="${productU.pFingeringEquipment}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>键盘描述</dt>
                <dd>
                    <label><input type="text" name="pKeyboard" value="${productU.pKeyboard}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>电池类型</dt>
                <dd>
                    <label><input type="text" name="pBatteryType" value="${productU.pBatteryType}" ></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>续航时间</dt>
                <dd>
                    <label><input type="number" name="pDuration" value="${productU.pDuration}" >小时</label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>电源适配器</dt>
                <dd>
                    <label><input type="text" name="pPowerAdapter" value="${productU.pPowerAdapter}" ></label>
                </dd>
            </dl>
            <%--电源描述--%>
            ...
            <dl>
                ...
                <dd>
                    <label><input type="number" name="pWeight" value="${productU.pWeight}" ></label>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <label><input type="number" name="pLengh"  value="${productU.pLengh}"></label>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <label><input type="number" name="pWidth" value="${productU.pWidth}" ></label>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <label><input type="number" name="pThickness"  value="${productU.pThickness}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>外壳描述</dt>
                <dd>
                    <label><input type="text" name="pShellDescription"  value="${productU.pShellDescription}"></label>
                </dd>
            </dl>
            <%--外观--%>
            ...
            <dl>
                <dt>安全性能</dt>
                <dd>
                    <label><input type="text" name="pSafety"  value="${productU.pSafety}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>散热系统</dt>
                <dd>
                    <label><input type="text" name="pDissipation" value="${productU.pDissipation}" ></label>
            ...
            <dl>
                <dt>附带软件</dt>
                <dd>
                    <label><input type="text" name="pSoftware" value="${productU.pSoftware}" ></label>
            ...
            <dl>
                <dt>包装清单</dt>
                <dd>
                    <label><input type="text" name="pPackagingList"  value="${productU.pPackagingList}"></label>
            ...
            <dl>
                <dt>质保时间</dt>
                <dd>
                    <label><input type="number" name="pWarranty" value="${productU.pWarranty}">年</label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>质保备注</dt>
                <dd>
                    <label><input type="text" name="pWarrantyRemark"  value="${productU.pWarrantyRemark}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>客服电话</dt>
                <dd>
                    <label><input type="tel" name="pTel" value="${productU.pTel}" ></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>电话备注</dt>
                <dd>
                    <label><input type="text" name="pTelRemark" value="${productU.pTelRemark}" ></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>详细内容</dt>
                <dd>
                    <label><input type="text" name="pDetail" value="${productU.pDatail}" ></label>
                </dd>
            </dl>
            <%--保修信息--%>
            ...
            <dl>
                <dt>CPU主频</dt>
                <dd>
                    <label><input type="number" name="pCPUHZ" value="${productU.pCPUHZ}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>最高睿频</dt>
                <dd>
                    <label><input type="number" name="pCPUMHZ"  value="${productU.pCPUMHZ}"></label>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <label><input type="number" name="pCPUAcount" value="${productU.pCPUAmount}">核心   <input type="number" name="pTread" value="${productU.pTread}">线程</label>
            ...
            <dl>
                <dt>三级缓存</dt>
                <dd>
                    <label><input type="number" name="pCache" value="${productU.pCache}"></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>总线规格</dt>
                <dd>
                    <label><input type="number" name="pBus" value="${productU.pBus}" ></label>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    <label><input type="number" name="pCraft" value="${productU.pCraft}" ></label>
            ...
            <dl>
                ...
                <dd>
                    <label><input type="number" name="pConsumption" value="${productU.pConsumption}" ></label>
                </dd>
            </dl>
            <%--处理器--%>
            ...
            <dl>
                <dt>硬盘描述</dt>
                <dd>
                    <label><input type="text" name="pROMDescription" value="${productU.pROMDescription}" ></label>
                </dd>
            </dl>
            ...
            <dl>
                <dt>图片</dt>
                <dd>
                    <label><input type="file" name="pPicture" value="${productU.pPicture}"></label>
                </dd>
            </dl>
        ...
        <div style="alignment: center;position: center;margin:0 auto; width:180px; height:20px;">
            <input type="submit" value="修改" style="background-color: #5bc0de;width: 80px;alignment: center;position: center">
