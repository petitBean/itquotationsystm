...
public class ProductP {
    ...
    public ProductP(String pCode, String pName, String tmCode, Date publishTime, String pType, String pPosition, String pOS, String pChipset, Integer pTouch, Integer pScreenSize, Integer pScreenResolution, String pTechnology, String pCamera, String pAudio, String pSpeaker, String pMike, String pWlan, String pLan, String pBluetooth, String pDataInterface, String pAudioInterface, String pVideoInterface, String pOtherInterface, String other1, String other2, String other3, String other4, String other5, String pFingeringEquipment, String pKeyboard, Integer pFingerprintIdentification, String pBatteryType, String pDuration, String pPowerAdapter, Integer pWeight, Integer pLengh, Integer pWidth, Integer pThickness, String pShellMaterial, String pShellDescription, String pSafety, String pDissipation, String pSoftware, String pPackagingList, String pGuarantee, Double pWarranty, String pWarrantyRemark, String pTel, String pTelRemark, String pDatail, String pPicture) {
        this.pCode = pCode;
        this.pName = pName;
        this.tmCode = tmCode;
        this.publishTime = publishTime;
